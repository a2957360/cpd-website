...
const Detail = (props) => {
  ...
  const [CertificateUrl, setCertificateUrl] = useState(props.data.CertificateUrl);
  ...
  const courseVideo = (e, ContentUrl, CourseContentTitle, Duration, index, CourseCompletedPer) => {
    console.log("into course update");
  ...
  useEffect(() => {
    setVideoContent(props.data.VideoContent);
  }, [props.data.VideoContent]);

  useEffect(() => {
    setCertificateUrl(props.data.CertificateUrl);
            ...
            <Col md={15} lg={15} className="pr-5">
              ...
              <Tabs defaultActiveKey={"1"} activeKey={menuKey} onChange={handleMenuClick}>
                ...
                <TabPane tab="Learning" key="2">
                  <Learning courseVideo={courseVideo} viewVideo={viewVideo} data={props.data.VideoContent} CourseContentTitle={CourseContentTitle} ContentUrl={ContentUrl} />
                </TabPane>
