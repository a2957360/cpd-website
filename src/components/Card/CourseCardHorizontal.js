...
const CourseCardHorizontal = (props) => {
  ...
  return (
    <>
      <div className="d-flex course-card" onClick={(e) => handleClickCard(e)}>
        ...
        <div className="d-flex flex-column pt-4 px-4 course-content-container--horizontal">
          <h2 className="color-dark-grey-3 fs-16 line-height-20">
            {CourseTitle}
          </h2>
          ...
          <span className="color-light-grey-2 fs-13 course-text mb-auto" dangerouslySetInnerHTML={{ __html: CourseDescription }} />
