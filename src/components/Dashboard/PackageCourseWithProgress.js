...
const CourseWithProgress = ({ course, parentId, type,packageName, CourseName }) => {
    ...
    <div
      ...
      onClick={() => {
        history.push({
          ...
          state: { data: course, type: "package", parentId: parentId,packageName: packageName, CertificateUrl: course.CertificateUrl },
        })
    ...
    >
      ...
      <div className='w-100 item-action-container px-3'>
        <Row justify='space-between' className='color-light-grey-2 px-2 justify-content-center'>
          ...
          {/* <span>{course.CourseCompletedPer}</span> */}
